...
public class Day20Test {
  ...
  public void simpleExample() {
    ...
    assertThat(Day20.furthestRoom(graph)).isEqualTo(3);
  }
  ...
  public void hallwayExample() {
    ...
    assertThat(Day20.furthestRoom(graph)).isEqualTo(10);
  }
  ...
  public void emptyExample() {
    ...
    assertThat(Day20.furthestRoom(graph)).isEqualTo(18);
  }
  ...
  public void example23() {
    ...
    assertThat(Day20.furthestRoom(graph)).isEqualTo(23);
  }
  ...
  public void example31() {
    ...
    assertThat(Day20.furthestRoom(graph)).isEqualTo(31);
  }
}